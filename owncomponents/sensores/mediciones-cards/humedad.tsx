...
const HumedadCard: React.FC<HumedadCardProps> = ({ card, data }) => {
  ...
  const renderCentralChart = async () => {
    ...
    if (chartElement) {
      ...
      updatedOptions.series[0].data = data.humedad;
      updatedOptions.series[0].name = "Humedad";
      updatedOptions.title.text = "Humedad";
      updatedOptions.yaxis[0].title = "Humedad";
    ...
    <div className="container-fluid row border-primary border-top p-1 mx-auto">
      {!showChartOnly && (
        <div className="col-11 col-sm-11 my-auto" id="datadiv">
          <div className="row">
            <h5>
              <img src="/water-droplet-icon.svg" width="50" height="50" alt="Water Droplet Icon" />
              <span className="fw-bolder">{valor(card, "humedad")} %</span>
            </h5>
          </div>
          <div className="row">
            <div className="col-4 fw-bolder">
              <div className="fw-strong">{valor(card, "humedad_min")} %</div>
              <div className="fw-light">Min</div>
            </div>
            <div className="col-4 fw-bolder">
              <div className="fw-strong">{valor(card, "humedad_mean")} %</div>
              <div className="fw-light">Promedio</div>
            </div>
            <div className="col-4 fw-bolder">
              <div className="fw-strong">{valor(card, "humedad_max")} %</div>
