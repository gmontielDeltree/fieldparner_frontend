...
const make_report = async (r : Recorrida) => {
	...
	let recorrida_static_map_url = mapbox_static_url(encodeURIComponent(JSON.stringify(r)));
	...
	let report : RecorridaInforme = {
		...
		meteorologia: [],
		logo_compania: "https://img.freepik.com/free-vector/bird-colorful-logo-gradient-vector_343694-1365.jpg",
		indices: [{name:"NDVI", url:ndvi_url},{name:"NDRE", url:"https://i.stack.imgur.com/dApg7.png"}]
