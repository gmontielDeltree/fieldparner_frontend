...
@customElement("dashboard-situacion")
export class DashboardSituacion extends LitElement {
  ...
  load_data() {
    fetch("/prices/car/soja/precios.csv")
      .then((result) => {
...
declare global {
  interface HTMLElementTagNameMap {
    "dashboard-situacion": AnalisisPrecios;
  }
}
