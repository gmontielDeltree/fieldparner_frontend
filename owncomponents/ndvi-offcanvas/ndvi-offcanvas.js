...
export class NdviOffcanvas extends LitElement {
  ...
  constructor() {
    super();
    this.ndvi_db = new PouchDB("https://apikey-v2-213njg3v1nihlky5l9jvum36ihirjsgu3dpddva8lfd0:7e233eca960bdea27bdc2a6db0251d89@ab6ed2ec-b5b6-4976-995e-39b79e891d70-bluemix.cloudantnosqldb.appdomain.cloud/ndvi")
  }
    ...
    ndvi_gallery = async (result) => {
      ...
      const create_update_ndvi_source = (img_src, bbox) => {
        ...
        if (this.map.getSource("ndvi")) {
          ...
          const mySource = this.map.getSource("ndvi");
