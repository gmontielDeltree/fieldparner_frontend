...
import gallery_css from 'lightgallery/css/lightgallery-bundle.css'
...
export class LightGalleryLit extends LitElement {
    ...
    static override styles = unsafeCSS(gallery_css)
    ...
    firstUpdated(): void {
        console.log("EJECUTANDO CODIGO DE LIT GALLERY")
