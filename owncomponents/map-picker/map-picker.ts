  ...
  static styles?: CSSResultGroup = [
    ...
    css`
      ...
      .overlay {
        ...
        z-index: 2; /* Sit on top, evita los controles de vaadin dialog */
        left: 0;
        top: 0;
  ...
  protected render(): unknown {
    return html`
      <vaadin-horizontal-layout style="align-items: flex-end;" theme="spacing">
          ...
          <vaadin-number-field
            label="${translate("latitud")}"
            .value=${"" + (this.posicion?.lat || "")}
            @input=${(e) => {
              this.posicion.lat = e.detail.value;
              this.emit_input_changed();
            }}
          ></vaadin-number-field>

          <vaadin-number-field
            label="${translate("longitud")}"
            .value=${"" + this.posicion?.lng || "0"}
            @input=${(e) => {
              this.posicion.lng = e.detail.value;
              this.emit_input_changed();
            }}
          >
          </vaadin-number-field>
