...
export const NewExitFieldPage: React.FC = () => {
  ...
  const steps = [t('general_data'), t('transport_destiny')];
  ...
  const onClickSaveExitField = async () => {
    ...
    try {
      ...
      await createExitField({
        ...
        humidityPercentage: safeHumidity.toString(),
        mermaPercentage: safeMerma.toString(),
        volatilePercentage: safeVolatile.toString(),
        otherPercentage: safeOther.toString(),
        grossWeight: safeGrossWeight.toString(),
        tareWeight: adjustedTareWeight.toString(),
        totalMerma: totalMerma.toString(),
        netWeight: netWeight.toString(),
        kgNet: kgNet.toString(),
      });
      reset();
      navigate('/init/overview/exit-field');
    } catch (error) {
      ...
      Swal.fire(
        'Error',
        'No se pudo crear la salida de campo. Por favor, verifique los datos e intente nuevamente.',
        'error',
      );
    }
  };
