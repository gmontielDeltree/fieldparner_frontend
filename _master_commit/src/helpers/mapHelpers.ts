...
export const showOnlyFieldBordersAndLotes = (
  map: MapboxMap,
  fieldId: string,
) => {
  console.log("Please show only the rest of the fields", fieldId);
  map.setFilter("campos-selected-line", ["in", "id", fieldId]);
...
export const setLoteAsSelected = (map: MapboxMap, loteId: string) => {
  map.setFilter("lotes-selected-line", ["in", "uuid", loteId]);
};

export const unsetLoteAsSelected = (map: MapboxMap) => {
  map.setFilter("lotes-selected-line", ["in", "uuid", ""]);
};
...
export const unsetFieldAsSelected = (map: MapboxMap) => {
  map.setFilter("campos-selected-line", ["in", "id", ""]);
};
