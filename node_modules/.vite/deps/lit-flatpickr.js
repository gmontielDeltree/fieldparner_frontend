import {
  LitElement,
  css
} from "./chunk-5UAUM3FO.js";
import {
  html
} from "./chunk-4B4GKOYJ.js";
import {
  __spreadProps,
  __spreadValues
} from "./chunk-P32JAGPA.js";
...
var createDateFormatter = function(_a2) {
  var _b = _a2.config, config = _b === void 0 ? defaults : _b, _c = _a2.l10n, l10n = _c === void 0 ? english : _c, _d = _a2.isMobile, isMobile = _d === void 0 ? false : _d;
...
var createDateParser = function(_a2) {
  var _b = _a2.config, config = _b === void 0 ? defaults : _b, _c = _a2.l10n, l10n = _c === void 0 ? english : _c;
...
var themeUrlPrefix2 = "https://npmcdn.com/flatpickr@4.6.9/dist/l10n";
async function loadLocale(locale) {
  const themeUrl = themeUrlPrefix2 + "/" + locale + ".js";
  const themeData = await import(themeUrl);
}

// node_modules/lit-flatpickr/dist/src/plugins/PluginLoader.js
var pluginUrlPrefix = "https://npmcdn.com/flatpickr@4.6.9/dist";
...
var LitFlatpickr = class LitFlatpickr2 extends LitElement {
  ...
  checkForSlottedElement() {
    var _a2;
    const slottedElem = (_a2 = this.shadowRoot) === null || _a2 === void 0 ? void 0 : _a2.querySelector("slot");
  ...
  async initializeComponent() {
    ...
    if (this._hasSlottedElement) {
      ...
      inputElement = (_a2 = this.shadowRoot) === null || _a2 === void 0 ? void 0 : _a2.querySelector("input");
    }
    if (inputElement) {
