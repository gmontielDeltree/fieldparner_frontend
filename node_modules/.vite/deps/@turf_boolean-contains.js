...
var es_default2 = booleanPointOnLine;
...
function booleanContains(feature1, feature2) {
  ...
  switch (type1) {
    ...
    case "LineString":
      switch (type2) {
        case "Point":
          return es_default2(geom2, geom1, { ignoreEndVertices: true });
        case "LineString":
...
function isMultiPointOnLine(lineString, multiPoint) {
  ...
  for (var _i = 0, _a = multiPoint.coordinates; _i < _a.length; _i++) {
    var coord = _a[_i];
    if (es_default2(coord, lineString, { ignoreEndVertices: true })) {
      haveFoundInteriorPoint = true;
    }
    if (!es_default2(coord, lineString)) {
      return false;
    }
  }
...
function isLineOnLine(lineString1, lineString2) {
  ...
  for (var _i = 0, _a = lineString2.coordinates; _i < _a.length; _i++) {
    var coords = _a[_i];
    if (es_default2({ type: "Point", coordinates: coords }, lineString1, {
...
function isLineInPoly(polygon, linestring) {
  var output = false;
  var i = 0;
  var polyBbox = es_default(polygon);
...
//# sourceMappingURL=@turf_boolean-contains.js.map
