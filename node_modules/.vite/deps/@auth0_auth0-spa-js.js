...
var lt = l(function(e2) {
  var t2 = Ae.f, n2 = Ye.CONFIGURABLE, r2 = ut.enforce, o2 = ut.get, i2 = !y(function() {
    ...
    String(o3).slice(0, 7) === "Symbol(" && (o3 = "[" + String(o3).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"), c3 && c3.getter && (o3 = "get " + o3), c3 && c3.setter && (o3 = "set " + o3), (!he(e3, "name") || n2 && e3.name !== o3) && t2(e3, "name", { value: o3, configurable: true }), i2 && c3 && he(c3, "arity") && e3.length !== c3.arity && t2(e3, "length", { value: c3.arity });
    var s2 = r2(e3);
    return he(s2, "source") || (s2.source = a2.join(typeof o3 == "string" ? o3 : "")), e3;
  };
...
var ft = function(e2, t2, n2, r2) {
  var o2 = !!r2 && !!r2.unsafe, i2 = !!r2 && !!r2.enumerable, a2 = !!r2 && !!r2.noTargetGet, c2 = r2 && r2.name !== void 0 ? r2.name : t2;
...
var Xt = function(e2, t2) {
  ...
  if (n2 = s2 ? p : u2 ? p[c2] || ce(c2, {}) : (p[c2] || {}).prototype)
    for (r2 in t2) {
      if (i2 = t2[r2], o2 = e2.noTargetGet ? (a2 = At(n2, r2)) && a2.value : n2[r2], !Pt(s2 ? r2 : c2 + (u2 ? "." : "#") + r2, e2.forced) && o2 !== void 0) {
...
var Dn = function(e2) {
  try {
    ...
    return function(e4, t2, n2) {
      for (var r2 = wt(e4), o2 = mt(t2, r2), i2 = mt(n2 === void 0 ? r2 : n2, r2), a2 = Nn(Jn(i2 - o2, 0)), c2 = 0; o2 < i2; o2++, c2++)
        fn(a2, c2, e4[o2]);
...
var No = function(e2, t2, n2, r2, o2, i2, a2) {
  ...
  }, f2 = t2 + " Iterator", d2 = false, h2 = e2.prototype, p2 = h2[Xo] || h2["@@iterator"] || o2 && h2[o2], y2 = !Ao && p2 || l2(o2), v2 = t2 == "Array" && h2.entries || p2;
  if (v2 && (c2 = Oo(v2.call(new e2()))) !== Object.prototype && c2.next && (Oo(c2) !== Po && (Zo ? Zo(c2, Po) : P(c2[Xo]) || ft(c2, Xo, Vo)), nr(c2, f2, true)), Lo && o2 == "values" && p2 && p2.name !== "values" && (Go ? Xe(h2, "name", "values") : (d2 = true, y2 = function() {
    return g(p2, this);
  })), o2)
...
Xt({ target: "Array", stat: true, forced: si }, { from: function(e2) {
  var t2 = fe(e2), n2 = Sn(this), r2 = arguments.length, o2 = r2 > 1 ? arguments[1] : void 0, i2 = o2 !== void 0;
...
var la = { getConstructor: function(e2, t2, n2, r2) {
  var o2 = e2(function(e3, o3) {
    ra(e3, i2), sa(e3, { type: t2, index: Vn(null), first: void 0, last: void 0, size: 0 }), v || (e3.size = 0), o3 != null && ta(o3, e3[r2], { that: e3, AS_ENTRIES: n2 });
  }), i2 = o2.prototype, a2 = ua(t2), c2 = function(e3, t3, n3) {
    var r3, o3, i3 = a2(e3), c3 = s2(e3, t3);
    return c3 ? c3.value = n3 : (i3.last = c3 = { index: o3 = ca(t3, true), key: t3, value: n3, previous: r3 = i3.last, next: void 0, removed: false }, i3.first || (i3.first = c3), r3 && (r3.next = c3), v ? i3.size++ : e3.size++, o3 !== "F" && (i3.index[o3] = c3)), e3;
  }, s2 = function(e3, t3) {
...
!function(e2, t2, n2) {
  ...
  if (Pt(e2, !P(a2) || !(o2 || c2.forEach && !y(function() {
    ...
    v2 || ((s2 = t2(function(e3, t3) {
      ...
      return t3 != null && ta(t3, n3[i2], { that: n3, AS_ENTRIES: r2 }), n3;
    ...
    return e3.prototype.acquireLock = function(t3, c3) {
      ...
      return n2(this, void 0, void 0, function() {
        ...
        return r2(this, function(r3) {
          switch (r3.label) {
            case 0:
              return n3 = window.localStorage, i3 = o2 + "-" + t3, (a3 = n3.getItem(i3)) === null ? [2] : (a3 = JSON.parse(a3)).id !== this.id ? [3, 2] : [4, Ia.default().lock(a3.iat)];
            case 1:
...
var Rc = function() {
  function e2(e3) {
    ...
    this.httpTimeoutMs = e3.httpTimeoutInSeconds ? 1e3 * e3.httpTimeoutInSeconds : 1e4, this.cookieStorage = e3.legacySameSiteCookie === false ? pc : yc, this.orgHintCookieName = (i2 = this.options.client_id, "auth0.".concat(i2, ".organization_hint")), this.isAuthenticatedCookieName = function(e4) {
...
var auth0_auth0_spa_js_default = jc;
export {
  Rc as Auth0Client,
  Ka as AuthenticationError,
  ja as GenericError,
  oc as InMemoryCache,
  rc as LocalStorageCache,
  Za as MfaRequiredError,
  Wa as PopupCancelledError,
  Fa as PopupTimeoutError,
  Ua as TimeoutError,
  Ec as User,
