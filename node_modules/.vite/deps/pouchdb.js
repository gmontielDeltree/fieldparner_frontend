  ...
  function queryPromised(db, fun, opts) {
    ...
    if (typeof fun !== "string") {
      ...
      tempViewQueue.add(function() {
        var createViewPromise = createView(db, "temp_view/temp_view", fun.map, fun.reduce, true, localDocName2);
      ...
      return db.get("_design/" + designDocName).then(function(doc) {
        ...
        var createViewPromise = createView(db, fullViewName, fun2.map, fun2.reduce, false, localDocName2);
        return createViewPromise.then(function(view) {
...
// dep:pouchdb
var pouchdb_default = index_browser_es_default;
export {
  pouchdb_default as default
};
