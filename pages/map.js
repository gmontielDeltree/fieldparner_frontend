...
zuix.controller(function (cp) {
	...
	var yourJWTToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiaWF0IjoxNjQ0ODcwMjgyLCJleHAiOjE2NDc0NjIyODJ9.cX-sHond5ZEAjNtZjevFynAL0f9BQQsfduhdFcbAutk"
	yourConfig = {
		headers: {
	...
	const campos_layer = () => {
		...
		axios.get("/api/campos", yourConfig).then(
			function (response) {
	...
	const campos_agregar_ctrl = () => {
		...
		axios.get('/api/cultivos', yourConfig)
			.then(function (response) {
				// handle success
